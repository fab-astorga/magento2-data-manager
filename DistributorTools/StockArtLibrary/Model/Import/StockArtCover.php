 ...
 */
class StockArtCover extends AbstractEntity
{
    const ENTITY_CODE          = 'stock_art_cover_entity';
    ...
    /**
     * @var \DistributorTools\StockArtLibrary\Api\StockArtCoverRepositoryInterface
     */
     ...
     * @param \DistributorTools\StockArtLibrary\Api\StockArtCoverRepositoryInterface $stockArtCoverRepository
     */
    ...
    private function initMessageTemplates()
    {
        ...
        $this->addMessageTemplate(
            'ThumbnailIsRequired',
            __('The thumbnail cannot be empty.')
        );
    }
    ...
    public function validateRow(array $rowData, $rowNum): bool
    {
        ...
        $thumbnail = $rowData[self::THUMBNAIL] ?? '';
        ...
        if (!$thumbnail) {
            $this->addRowError('ThumbnailIsRequired', $rowNum);
        }
    ...
    {
        foreach ($entityList as $stockArtCover) 
        {                 
            $this->_stockArtCoverRepository->save(
                $stockArtCover[self::ENTITY_ID_COLUMN],
                $stockArtCover[self::NAME],
                $stockArtCover[self::THUMBNAIL],
                $stockArtCover[self::IMG]
            );
        }
    ...
    { 
        $this->_stockArtCoverRepository->delete(); 
    }
}