 ...
 */
class CandyFillOptionsPrices extends AbstractEntity
{
    const ENTITY_CODE      = 'candy_options_prices';
    ...
    /**
     * @var \Services\CandyFillOptions\Api\CandyFillOptionsPricesRepositoryInterface
     */
     ...
     * @param \Services\CandyFillOptions\Api\CandyFillOptionsPricesRepositoryInterface $candyFillOptionsPricesRepository
     */
    ...
    {
        foreach ($entityList as $candyFillOptionsPrice) 
        { 
            $this->_candyFillOptionsPricesRepository->save(
                $candyFillOptionsPrice[self::ENTITY_ID_COLUMN],
