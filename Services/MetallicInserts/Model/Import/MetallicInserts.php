...
namespace Services\MetallicInserts\Model\Import;
 ...
 */
class MetallicInserts extends AbstractEntity
{
    const ENTITY_CODE          = 'metallic_inserts';
    ...
    /**
     * @var \Services\MetallicInserts\Api\MetallicInsertsRepositoryInterface
     */
     ...
     * @param \Services\MetallicInserts\Api\MetallicInsertsRepositoryInterface $metallicInsertsRepository
     */
    ...
    {
        foreach ($entityList as $metallicInsert) 
        {                 
            $this->_metallicInsertsRepository->save(
                $metallicInsert[self::ENTITY_ID_COLUMN],
