...
/**
 * Class GlitterInsertsPrices
 */
class GlitterInsertsPrices extends AbstractEntity
{
    const ENTITY_CODE      = 'glitter_inserts_prices';
    ...
    /**
     * @var \Services\GlitterInserts\Api\GlitterMetallicInsertsPricesRepositoryInterface
     */
     ...
     * @param \Services\GlitterInserts\Api\GlitterInsertsPricesRepositoryInterface $glitterMetallicInsertsPricesRepository
     */
    ...
    {
        foreach ($entityList as $glitterMetallicInsertsPrice) 
        { 
            $this->_glitterMetallicInsertsPricesRepository->save(
                $glitterMetallicInsertsPrice[self::ENTITY_ID_COLUMN],
